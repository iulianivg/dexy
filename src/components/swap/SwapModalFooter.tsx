    ...
    <>
      <AutoColumn gap="0px">
        <RowBetween align="center">
          <Text fontSize="14px"             style={{color:'black'}}>Price</Text>
          <Text
            fontSize="14px"
            style={{
        ...
        <RowBetween>
          ...
          <RowFixed>
            ...
            <Text fontSize="14px" marginLeft="4px"             style={{color:'black'}}>
              {trade.tradeType === TradeType.EXACT_INPUT
        ...
        <RowBetween>
          <RowFixed>
            <Text fontSize="14px"             style={{color:'black'}}>Price Impact</Text>
            <QuestionHelper
        ...
        <RowBetween>
          <RowFixed>
            <Text fontSize="14px"             style={{color:'black'}}>Liquidity Provider Fee</Text>
            <QuestionHelper
              text={TranslateString(
                999,
